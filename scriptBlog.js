...
blogConteiner = document.getElementsByClassName('blogConteiner'),
heightblogConteiner= $(document.getElementsByClassName('blogConteiner')).outerHeight(),
...
$(document).ready ( function(){
    $(blogConteiner).css('padding-top', heightHeader);
});
...
$(closeNewsHeader).click(function (e) { 
    ...
    heightHeader = $(document.getElementsByClassName('header')).outerHeight();
    $(blogConteiner).css('padding-top', heightHeader+heightblogConteiner);
});
...
$(textNews).hover(
    function (e) {
        ...
        imgActiveNews = '#imgNews' + activeNews.slice(9,10)
        console.log(activeNews, imgActiveNews)
        $(activeNews).animate({
            height: '80%'
        },500)
